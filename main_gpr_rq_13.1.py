...
if __name__ == "__main__":
    ...
    # Define RationalQuadratic kernel
    ...
    param_grid = {
        ...
        'regressor__kernel__k1__constant_value': [0.5, 1.0, 2.0],  # ConstantKernel's value
        'regressor__kernel__k2__length_scale': [0.5, 1.0, 2.0],    # RationalQuadratic's length_scale
        'regressor__kernel__k2__alpha': [0.1, 1.0, 10.0],          # RationalQuadratic's alpha
    }
