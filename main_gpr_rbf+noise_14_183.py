...
if __name__ == "__main__":
    ...
    param_grid = {
        ...
        'regressor__kernel__k1__k1__constant_value': [0.5, 1.0, 2.0],
        'regressor__kernel__k1__k2__length_scale': [0.5, 1.0, 2.0],
        'regressor__kernel__k2__noise_level': [0.01, 0.1, 1.0]
    }   


    # K-Fold cross-validation setup (7 folds)
